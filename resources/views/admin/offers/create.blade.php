...
<script>
// Configure axios authentication (layout already sets up token)
(function() {
...
document.getElementById('offer-form').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        const response = await axios.post('/api/admin/offers', data, {
        ...
        toast.error('Failed to create offer: ' + message);
    }
});
</script>
@endsection
