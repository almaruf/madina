...
@section('content')
<div class="space-y-6 max-w-6xl mx-auto" data-shop-slug="{{ $slug }}">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900">Edit Shop</h1>
        <a href="/admin/shops/{{ $slug }}" class="text-gray-600 hover:text-gray-900">← Back to Shop Details</a>
    </div>
    ...
    <div id="shop-form-container" class="hidden bg-white rounded-lg shadow">
        <!-- Tabs Navigation -->
