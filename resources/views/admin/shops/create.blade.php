...
<div class="space-y-6 max-w-4xl">
    ...
    <form id="shop-form" class="bg-white rounded-lg shadow p-6 space-y-6" onsubmit="saveShop(event)">
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="flex items-center gap-4">
                <label class="flex items-center gap-2">
                    <input type="checkbox" id="delivery_enabled" checked class="rounded text-green-600">
            ...
            <div class="md:col-span-2 border-t pt-6">
                <label class="flex items-center gap-2">
                    <input type="checkbox" id="is_active" checked class="rounded text-green-600">
        ...
        <div class="flex gap-3 pt-4">
            ...
            <button type="submit"
                    class="px-6 py-2 rounded-lg bg-green-600 text-white font-semibold hover:bg-green-700">Create Shop</button>
        </div>
    </form>
</div>
